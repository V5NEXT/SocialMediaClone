    ...
    <div className='flex xl:flex-col flex-col m-auto bg-white' style={{maxWidth: '1500px', borderRadius:'32px'}}>
      ...
      <div className='w-full p-5 flex-1 xl:min-w-620'>
        <div className='flex items-center justify-between'>
          ...
          <a href={pinDetail.destination} target="blank" rel="nonreferer">
     ...
     <input className='flex-1 border-gray-100 outline-none p-2 border-2 rounded-2xl focus:border-gray-300'
             type='text'
